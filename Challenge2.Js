...
const pay_tax_rates = [
  ...
  // Calculations for PAYE (tax) based on monthly taxable pay
  ...
  // Calculations for NHIF deductions based on gross pay
  ...
  // Calculations for NSSF deductions based on pensionable pay
  function calculateNSSF(pensionablePay) {
    return pensionablePay * nssf_rate;
  }
  
  // Calculations for calculate gross salary
